...
module "eks-addons" {
  ...
  vpc_id                                  = "vpc-007b2c164a9ef1c31"
  private_subnet_ids                      = ["subnet-08e2ddc7eb764c345", "subnet-0d222d561fd53830d"]
  environment                             = local.environment
  ipv6_enabled                            = local.ipv6_enabled
  kms_key_arn                             = "arn:aws:kms:us-west-2:767398031518:key/mrk-1fdce43cc37843b691c13f62eac8500e"
  ...
  single_az_ebs_gp3_storage_class_enabled = false #akanksha
